...
export const registerAdmin = (user) => (dispatch) => {
  axios
...
export const updateUserData = (userData) => (dispatch) => {
  axios
    .put('/api/users/updateData', userData)
    .then((res) => {
...
export const setUserColor = (color) => (dispatch) =>
  dispatch({
    type: SET_USER_COLOR,
    payload: color,
  });
