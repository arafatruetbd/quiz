...
class Dashboard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      color: '',
      rankColor: ['#d2d2d2', '57b846', '#debb00'],
    };
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        <Helmet>
          <title>
            Dashboard - {this.state.firstName} {this.state.lastName} - Quiz
          </title>
        </Helmet>
        <div className="dashboard">
          ...
          <section className="main">
              ...
              <div className="initials-container">
                ...
                <h4 className="show-on-small" id="logo">
                  <span
                    ...
                    className="mdi mdi-menu sidenav-trigger left menu-icon"></span>
                  Logo
                </h4>
            ...
            <section className="main-content">
              <h4 style={{ color }} id="greeting">
                {this.greetUser()}
              </h4>
              <div className="stat-content">
                <div className="stat">
                  <h5>
                    <span className="mdi mdi-currency-ngn mdi-24px stat-icon"></span>
                    {this.state.balance}
...
export default connect(mapStateToProps, { logoutUser, setUserColor })(
  Dashboard
);
