        ...
        <div className="dashboard">
          <section className="aside">
            ...
            <ul>
              <li>
                <Link to="/dashboard">
                  <span className="mdi mdi-view-dashboard-outline link-icon mdi-24px"></span>
                  Dashboard
                </Link>
              </li>
              <li>
                <Link to="/play/instructions">
                  <span className="mdi mdi-cube-outline link-icon mdi-24px"></span>
                  Play Game
                </Link>
              </li>
              <li>
                <Link to="/profile">
                  <span className="mdi mdi-settings link-icon mdi-24px"></span>
                  Profile
                </Link>
              </li>
              <li className="funds-active">
                <Link to="/funds">
                  <span className="mdi mdi-credit-card link-icon mdi-24px"></span>
                  Funds
                </Link>
              </li>
              <li>
                <Link to="/support">
                  <span className="mdi mdi-help-circle-outline link-icon mdi-24px"></span>
                  My Rank
                </Link>
              </li>
            </ul>
          ...
          <section className="main">
              ...
              <div className="initials-container">
                ...
                <h4 className="show-on-small" id="logo">
                  <span
                    ...
                    className="mdi mdi-menu mdi-24px sidenav-trigger left menu-icon"></span>
                  Logo
                </h4>
                <ul className="sidenav" id="mobile-menu">
                  ...
                  <li onClick={this.handleLogoutUser}>
                    <Link to="/#">
                      <span
                        style={{ color: '#ea4335' }}
                        className="mdi mdi-power mdi-24px link-icon logout-icon"></span>
                      Log out
                    </Link>
                  </li>
                </ul>
                <div>
                  ...
                  <p style={{ backgroundColor: color }} className="initials">
            ...
            <section className="main-content">
              <div className="funds-content">
                <div
                  className={classnames('funds-info', {
                    hide: state.showCardDetails === false,
                  })}>
                  <div>
                ...
                <div
                  className={classnames('bank-container', {
                    hide: state.showBankDetails === false,
                  })}>
                  <div className="bank-details">
                    ...
                    <p>
                      <span className="title">Bank Name:</span> {state.bank}
                    </p>
                  </div>
                ...
                <section
                  className={classnames('payment-message', {
                    hide: state.showPaymentNotification === false,
                  })}>
                  <p>
                    <span className="mdi mdi-information-outline mdi-24px"></span>
                    Payment information is unavailable or incomplete. Please add
                    a bank account and (or) a credit card to enable you make and
                    receive payments.
                  </p>
                  <div>
                    <button
                      className={classnames('add-payment', {
                        hide: state.showAddCardButton === false,
                      })}
                      id="add-card"
                      onClick={this.handleAddPayment}>
                      Add Credit Card
                    ...
                    <button
                      className={classnames('add-payment', {
                        hide: state.showAddBankButton === false,
                      })}
                      id="add-bank"
                      onClick={this.handleAddPayment}>
                      Add Bank Account
                ...
                <form
                  ...
                  className={classnames('', {
                    hide: state.showBankForm === false,
                  })}>
                  <h5>Bank Account Details</h5>
                  <p>
                    Enter your local bank account details to be enable us send
                  ...
                  <div className="col">
                    ...
                    <button
                      disabled={state.disableEditBank}
                      id="edit-bank"
                      type="submit">
                      Edit Details
                    </button>
                ...
                <form
                  ...
                  id="card-form"
                  className={classnames('', {
                    hide: state.showCardForm === false,
                  })}>
                  <h5>Credit Card Information</h5>
                  <p>Provide card details to enable you fun bd your e-wallet.</p>
            ...
            <div>
              <p>&copy; Copyright Arafat 2019</p>
            </div>
          </section>
        </div>
