      ...
      stats = (
        <Fragment>
          ...
          <div className="container stats">
            <h4>{remark}</h4>
            <h2
              className={classnames('perfect-score', {
            ...
            <span className="right">{this.state.usedHints} out of 5</span>
            <br />
            <span className="stat left">50-50 used: </span>
            <span className="right">{this.state.usedfiftyFifty} out of 2</span>
            <br />
          </div>
          <section>
            <ul>
            ...
            <p>
              Want to earn really cool cash while playing games?{' '}
