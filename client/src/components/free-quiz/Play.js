...
class Play extends Component {
  ...
  displayQuestion(
    ...
    console.log('this state question:' + this.state.questions);
  ...
  handleOptionClick = (e) => {
    ...
    if (this.state.numberOfQuestions === 0) {
      const questionsArray = Object.keys(this.state.questions).map(
        (i) => this.state.questions[i]
      );
      this.setState({
  ...
  endGame = () => {
    ...
    this.props.updateRank(quizRank);
  ...
  render() {
    ...
    if (isEmpty(questions) || loading === true) {
      quizContent = <h1 style={{textAlign:'center'}}>No Question Found</h1>;
    } else {
      quizContent = (
        <Fragment>
          <Helmet>
            <title>Free Quiz - Quiz</title>
          </Helmet>
          <Fragment>
              ...
              <p>
                {this.state.hints > 0 ? (
                  <span
                    ...
                    id="hints"
                    className={classnames(
                      'mdi mdi-lightbulb-on mdi-24px lifeline-icon',
                      {
          ...
          <div className="buttonContainer">
            <button
              ...
              <span
                ...
                className="mdi mdi-chevron-double-left left"></span>
              Previous
            </button>
            <button
              className={classnames('', {
              ...
              <span
                ...
                className="mdi mdi-chevron-double-right right"></span>
              Next
            </button>
            <button onClick={this.hadleQuitButtonClick}>
              <span
                style={{ marginLeft: '5px' }}
                className="mdi mdi-close right"></span>
              Quit
            </button>
          </div>
        </Fragment>
    ...
    return (
      <div id="quiz">
        <h3 style={{textAlign:'center'}}>Free Quiz Mode</h3>
