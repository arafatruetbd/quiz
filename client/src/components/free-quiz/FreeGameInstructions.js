...
class Play extends Component {
    render () {
        return (
            <Fragment>
                <Helmet><title>Game Instructions - Quiz</title></Helmet>
                <div className="instructions container">
                    ...
                    <ul className="browser-default" id="main-list">
                        ...
                        <li>
                            ...
                            <img src={options} alt="Quiz options example"/>
                        </li>
                        <li>
                            Select the option which best answers the question by clicking (or selecting) it.
                            <img src={answer} alt="Quiz answer example"/>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <img src={fiftyFifty} alt="Quiz 50-50 answer example"/>
                        </li>
                        <li>
                            ...
                            <img src={hints} alt="Quiz hints example"/>
                        </li>
