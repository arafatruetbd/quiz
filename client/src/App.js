...
import LoginAdmin from './components/auth/LogAdmin';
				...
				<Router>
					<ScrollToTop>
						<Fragment>
							...
							<Switch>
								<PrivateRoute path="/dashboard/admin/add" exact component={AddQuestion} />
							</Switch>
							<Switch>
								<PrivateRoute path="/dashboard/admin/edit/:id" exact component={EditQuestion} />
							</Switch>
							<Switch>
